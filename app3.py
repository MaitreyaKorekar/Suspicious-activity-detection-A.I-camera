...
file_path = None
camera = None
model = load_model("C:/Users/Maitreya/OneDrive/Desktop/Sap codeunnati marathon project/Violence/modelnew.h5")
Q = deque(maxlen=128)
...
def upload_file():
    if request.method == 'POST':
        ...
        global file_path
        file_path = os.path.join(r"C:\Users\Maitreya\OneDrive\Desktop\Sap codeunnati marathon project\Violence\Upload", file.filename)
        file.save(file_path)
        # process the file
    return Response(generate_frames(), mimetype='multipart/x-mixed-replace; boundary=frame')
